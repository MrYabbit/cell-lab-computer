...
export const STRETCH_GAP_POWER = 1.2;
export const STRETCH_MULTIPLIER = 100/2;
...
export const ROTATE_POWER = 1;
export const ROTATE_MULTIPLIER = 50; // Rotation will be multiplied by this
